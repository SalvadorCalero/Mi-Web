...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $proyectos = [
            ...
            [
                'title' => 'Box Akyles',
                'description' => 'Se tradujo a otro idioma, se ha colaborado a la maquetación de la web',
            ...
            [
                ...
                'description' => 'Maquetación de la web.',
            ...
            [
                'title' => 'Tailor Seeds',
                'description' => 'Maquetación de la web y traducción a varios idiomas.',
